...
- Built real-time FEC fraud detection and analysis system (live at https://elect.info) using Python, Pandas, and PySpark — processing billions of records across a political spending sub-economy valued over **$2** trillion
