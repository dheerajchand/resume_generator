...
def test_placeholder_detection():
    ...
    # Test cases
    test_cases = [
        ("Your Company Name, Your City, ST", ["Your Company Name", "Your City, ST", "Company Name", "Your City", "Your Company"]),
...
def test_complete_resume_validation():
    ...
    try:
        ...
        print(f"Complete validation result: {'❌' if not validation_result.is_valid else '✅'}")
