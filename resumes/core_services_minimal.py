...
from resume_generator_django.resume_generator.constants import (
    ...
    FOOTER_LINK_OFFSET,
    FOOTER_Y,
    HEADER_FIRST_GITHUB_Y,
    HEADER_FIRST_LOCATION_Y,
    HEADER_FIRST_PHONE_Y,
    HEADER_GITHUB_LINK_OFFSET,
    HEADER_GITHUB_OFFSET,
    HEADER_LEFT_X,
    HEADER_LOCATION_LINK_OFFSET,
    HEADER_LOCATION_OFFSET,
    HEADER_NAME_OFFSET,
    HEADER_PHONE_OFFSET,
    HEADER_RECURRING_EMAIL_Y,
    HEADER_RECURRING_GITHUB_Y,
    HEADER_RECURRING_NAME_Y,
    HEADER_RECURRING_PHONE_Y,
    HEADER_TOP_Y,
    MARGIN_LEFT,
    MARGIN_RIGHT,
    PAGE_HEIGHT,
...
class ResumeGenerator:
    ...
    def __init__(self, data_file: str, config_file: str | None = None, color_scheme: str = 'default_professional'):
