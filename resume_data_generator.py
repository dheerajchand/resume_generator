...
Examples:
  ...
  python resume_data_generator.py --color-scheme modern_tech
    ...
    research_config = create_config_file(user_config, "research_focused", color_scheme_name)
    ...
    technical_config = create_config_file(user_config, "technical_detailed", color_scheme_name)
    ...
    comprehensive_config = create_config_file(user_config, "comprehensive_full", color_scheme_name)
    save_resume_data(user_config, "comprehensive", comprehensive_data, comprehensive_config)

    # Consulting minimal version
    consulting_data = create_consulting_minimal_data(user_config)
    consulting_config = create_config_file(user_config, "consulting_minimal", color_scheme_name)
    ...
    engineer_config = create_config_file(user_config, "software_engineer", color_scheme_name)
    ...
    product_marketing_config = create_config_file(user_config, "product_marketing", color_scheme_name)
    save_resume_data(user_config, "marketing", product_marketing_data, product_marketing_config)

    print("\n✅ Resume data generation complete!")
    print(f"\n👤 User: {user_config.name}")
    print(f"🎨 Color scheme: {color_scheme_name}")
    print("\n📋 Generated versions:")
    print(f"   • {user_config.get_version_directory_name('research')} - Emphasizes applied research leadership")
    print(f"   • {user_config.get_version_directory_name('technical')} - Shows engineering depth and technical skills")
    print(f"   • {user_config.get_version_directory_name('comprehensive')} - Complete work history with all details")
    print(f"   • {user_config.get_version_directory_name('consulting')} - Strategic advisor focused")
    print(f"   • {user_config.get_version_directory_name('software')} - Software engineering and platform development (DEFAULT)")
    print(f"   • {user_config.get_version_directory_name('marketing')} - Product marketing strategy and go-to-market leadership")
    ...
    print(f"   4. Try different color schemes with: python resume_manager.py --generate-data --color-scheme [scheme_name]")
